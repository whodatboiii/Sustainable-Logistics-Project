...
def modelling():
    ...
    transit_callback_index = model.RegisterTransitCallback(lambda from_index, to_index: weighted_distance_callback(manager, locations, from_index, to_index))
    ...
    search_parameters.time_limit.seconds = 60  # Set time limit to 60 seconds
